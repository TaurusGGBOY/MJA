...
Any existing MaaFramework checkout is reference material only; the build process
must use a separate clean clone or archive and must never modify or fetch into
that checkout.
