...
def test_planner_action_clicks_only_multiplier_and_never_count():
    ...
    assert context.controller.actions == [("click", (1206, 427))]


def test_planner_clicks_multiplier_position_from_stamina_without_count_input():
    context = FakeContext(nodes={
        "0788-剑林凝结体体力-计划",
        "0789-剑林凝结体体力-体力耗尽",
        "0934-剑林凝结体体力-挑战-凝结体",
    ...
    assert context.next_overrides == []
    assert context.controller.actions == [("click", (1040, 427))]
